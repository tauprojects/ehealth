...
public class ListToJsonStringConverter implements AttributeConverter<List<Object>, String> {
    ...
    public List<Object> convertToEntityAttribute(String dbData) {
        ...
        if (dbData != null) {
            try {
                attributes = objectMapper.readValue(dbData, new TypeReference<List<Object>>() {
                });
            } catch (IOException e) {
